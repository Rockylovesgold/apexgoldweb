...
const team = [
  {
    ...
    description:
      "Anthony is the founder of Apex Gold Trading and a serial entrepreneur with a track record of building and scaling businesses across multiple industries. A qualified Gas Safe and plumbing engineer by trade, he expanded into renewable energy — establishing and exiting both an ECO4 company and a solar panel business — before going on to own and operate a tyre garage, car wash, and a property investment company alongside his brothers. His entrepreneurial instinct is matched by a deep commitment to financial education: with over eight years of experience trading cryptocurrency and gold (XAU/USD) markets, he founded Apex Gold Trading with one mission — to help people create genuine financial freedom using nothing more than a phone or laptop, from anywhere in the world. What began as a private Telegram group has grown into a global community of 5,000+ traders receiving 8–10 daily signals with a reported 91% win rate.",
    socials: {
